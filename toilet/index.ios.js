        ...
        return (
            < TabBarIOS >
                < TabBarIOS.Item
                    ...
                    selected={this.state.selectTab === "toilet"}
                    onPress={() => {
                        this.setState({
                            selectTab: "toilet"
                        });
                ...
                < TabBarIOS.Item
                    ...
                    selected={this.state.selectTab === "read"}
                    onPress={() => {
                        this.setState({
                            selectTab: "read"
                        });
                ...
                < TabBarIOS.Item
                    ...
                    selected={this.state.selectTab === "weather"}
                    onPress={() => {
                        this.setState({
                            selectTab: "weather"
                        });
                ...
                < TabBarIOS.Item
                    ...
                    selected={this.state.selectTab === "setting"}
                    onPress={() => {
                        this.setState({
                            selectTab: "setting"
                        });
